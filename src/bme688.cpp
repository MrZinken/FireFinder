...
bool setupBME688()
{
    ...
    debug_println("BME688 setup done");
...
BME688Data readBME688()
{
    ...
    {
        debug_println("[BME688] Error: Failed to complete measurement!");
    }
    ...
    data.temperature = bme688.temperature+100;
    debug_println("BME688 reading done ");
